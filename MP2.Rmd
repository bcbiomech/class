...
2. State an hypothesis as to how pelvic tilt will change with human size in terms of mass and height and sex. Do your data support this?
...
Notice how they are similarly named "walk_speed_subject.txt". That makes it easy to extract metadata from the file names. Now, as we did in the first , let's concatenate all the data into one data frame for subsequent plotting and analysis. 

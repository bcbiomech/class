...
First, we need a way of converting our phone videos into a format readable by FIJI/imageJ. The AVI format is essentially a stack of raw images that is readable by almost any software. So let's convert our videos to AVI. Fortunately, R can do that for us if we have the `av` package installed.

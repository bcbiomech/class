...
New MPs will be released on Thursdays with an MP project description (see links above under and our [schedule](schedule.html) page). These project descriptions begin with some background, a survey of some of the important concepts from class that we'll invoke in the MP, and the question we'll seek to answer. From there, you'll move on to performing experiments or simulations and collect data to answer the MP's question.
...
Before the deadline for each MP, **EVERY** group member of each team must submit an evaluation of their own and their teammates' contributions to the project. These evaluations can be made using [this form](https://forms.gle/1CMXtch2feruGxoX9). Please check out our [Author Contribution Evaluation](author_contributions.html) page for more information.

...
**Delivery:**  In-person lectures Tuesday and some Thursdays from noon--1:15 in Higgins Hall 225. Asynchronous lab projects launched on Thursdays.
...
Office hours, either in person on via Zoom, can be arranged by appointment via email so Slack. Office hours may involve more more than student or team, so please come equipped with poignant questions and expect that other students have questions as urgent as yours.

...
Prof. Kenaley will help you initiate the program that reads the load data from the load cell system. The program will depress a cylinder against the span of the wooden beam at a slow speed while it reads the load in grams. We will bend the dry piece with the wide side flat against the supports ("flat", left in the figure below) and then flip it 90$^\textrm{o}$ so that the thin side rests against the supports ("flipped", right in the figure below). 
...
In total, we will have preformed 4 experiments:

```{r,echo=FALSE,message=FALSE}

library(tidyverse)
data.frame(d=c("dry","dry","wet","wet"),o=c("flat","flipped","flat","flat"),s=c("slow","slow","fast","slow")
